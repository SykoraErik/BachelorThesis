...
\thesislong{abstract}{
Cílem této práce je pomocí vhodných nástrojů vytvořit sadu funkčních testů pro webovou aplikaci Slepé Mapy. Součástí práce je rozbor použitých technologií a různých metod vhodných pro funkční testování webové aplikace. Část práce je také věnována analýze testované aplikace. Důraz je také kladen na ukázku práce se zvolenými nástroji. Závěrem je  popsána automatizace vytvořené testové sady pomocí vybraného nástroje průběžné integrace.
}
\thesislong{thanks}{
...
\lstset{language=Java, caption={Deklarace třídy WorldMapTest a jejích atributů}, escapeinside={\%*}{*)}} 
\begin{lstlisting}
